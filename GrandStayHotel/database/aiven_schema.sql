...
-- Aiven Cloud MySQL Schema (use with defaultdb)
-- DO NOT include CREATE DATABASE or USE statements for Aiven
...
-- Insert fixed admin credentials (email: admin@grandstayhotel.com | password: Admin@123)
